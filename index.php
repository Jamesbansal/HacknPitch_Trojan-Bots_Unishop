         ...
         <div class="main-product">
            <div class="container">
               ...
               <div class="row clearfix">
                  ...
                  <div class="col-lg-3 col-sm-6 col-md-3">
                     <a href="product.php?cat=kitchen">
                        <div class="box-img">
                  ...
                  <div class="col-lg-3 col-sm-6 col-md-3">
                     <a href="product.php?cat=vehicles">
                        <div class="box-img">
                           <h4>Vehicles</h4>
                           <img src="images/product/Vehicles.png" alt="" />
                        </div>
                     </a>
                  </div>
                  <div class="col-lg-3 col-sm-6 col-md-3">
